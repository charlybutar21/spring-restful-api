...
import com.charly.springrestfulapi.model.RegisterUserRequest;
import com.charly.springrestfulapi.model.UpdateUserRequest;
import com.charly.springrestfulapi.model.UserResponse;
...
class UserControllerTest {
    ...
    void updateUserSuccess() throws Exception {
        ...
        mockMvc.perform(
            ...
            assertNull(response.getErrors());
            assertEquals("Charly", response.getData().getName());
            assertEquals("test", response.getData().getUsername());
